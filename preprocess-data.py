...
# Paths relative to /app (Docker WORKDIR)
CSV_FILE = "chewy/chewy_scraper_sample.csv"
INDEX_FILE = "chewy/chewy_index.faiss"
KNOWLEDGE_BASE_FILE = "chewy/knowledge_base.json"
METADATA_FILE = "chewy/doc_metadata.json"

# Check if preprocessing is needed (idempotent for Docker builds/restarts)
if os.path.exists(INDEX_FILE):
    ...
    if not os.path.exists(CSV_FILE):
        raise FileNotFoundError(f"CSV file not found: {CSV_FILE}. Ensure it's in the chewy/ directory.")
    ...
    # Save knowledge base
    os.makedirs("chewy", exist_ok=True)  # Ensure dir exists
    with open(KNOWLEDGE_BASE_FILE, "w", encoding='utf-8') as f:
        json.dump(knowledge_base, f, ensure_ascii=False, indent=2)

    # Initialize SentenceTransformer (model caches automatically)
    ...
    print("Preprocessing complete. Generated chewy/knowledge_base.json, chewy/chewy_index.faiss, and chewy/doc_metadata.json.")